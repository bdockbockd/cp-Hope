...
//		}
	...
	public static int getKeyCombination() {
		if (directionInput.size() == 1) {
			...
			} else if (directionInput.contains("LEFT") && directionInput.contains("RIGHT")
					&& directionInput.contains("DOWN")) {
				return 4;

			} else if (directionInput.contains("RIGHT") && directionInput.contains("UP")
					&& directionInput.contains("DOWN")) {
				return 2;
