...
//		}
	...
	// public static final Font mcfont = Font.createFont(Font.TRUETYPE_FONT,new
	// Font(getClass().getClassLoader().getResourceAsStream("assets/minecraft/font/mcfont.ttf")));
}
